...
document.querySelector('.admin-top nav')?.insertAdjacentHTML('afterbegin','<a class="admin-nav-link" href="/admin/">პროდუქტები</a><a class="admin-nav-link active" href="/admin/chargers/">დამტენები</a><a class="admin-nav-link" href="/admin/layers/">ფენები</a><a class="admin-nav-link" href="/admin/info/">ინფორმაცია</a>');
