...
function setDarkMode(enabled){document.body.classList.toggle('dark-map',enabled);$('darkMode').setAttribute('aria-pressed',String(enabled));localStorage.setItem('chargerx-map-dark',String(enabled));map.triggerRepaint()}
...
$('darkMode').onclick=()=>setDarkMode(!document.body.classList.contains('dark-map'));
